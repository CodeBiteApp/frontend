        ...
        <View style={styles.formCard}>
          ...
          <View style={styles.fieldBlock}>
            ...
            <View
              style={[
                styles.inputWrap,
                nickname.length > 0 && styles.inputWrapActive,
              ]}
            >
              <TextInput
                style={styles.input}
          ...
          <View style={styles.fieldBlock}>
            ...
            <View
              style={[
                styles.inputWrap,
                userCode.length > 0 && styles.inputWrapActive,
              ]}
            >
              <TextInput
          ...
          <TouchableOpacity
            style={[
              styles.searchBtn,
              !nicknameValid && styles.searchBtnDisabled,
            ]}
            ...
            {loading ? (
              ...
              <Text
                style={[
                  ...
                  !nicknameValid && styles.searchBtnTextDisabled,
                ]}
              >
                검색하기
              </Text>
        ...
        {error ? (
          ...
          <View style={styles.tipBox}>
            ...
            <Text style={styles.tipText}>
              닉네임이 같은 유저가 여럿이면{" "}
              <Text style={styles.tipHighlight}>친구 코드</Text>를 함께 입력해
              정확히 찾을 수 있어요.{"\n"}
...
const styles = StyleSheet.create({
  ...
  scroll: { flex: 1 },
  content: { paddingTop: 16, paddingBottom: 24, paddingHorizontal: 20 },
